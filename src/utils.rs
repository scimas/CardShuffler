...
pub fn bad_char_err(param: &str) {
    println!(
        "Bad characters in {}, make sure it is a positive integer",
        param
    );
}
...
pub fn get_players() -> u8 {
    loop {
        ...
        io::stdin()
            ...
            .expect("Couldn't read the number of players");
...
pub fn get_num_decks() -> u8 {
    loop {
        ...
        io::stdin()
            ...
            .expect("Couldn't read the number of decks");
...
pub fn get_num_cards() -> u8 {
    loop {
        ...
        io::stdin()
            ...
            .expect("Couldn't read the number of cards");
...
pub fn get_dealing_round() -> u8 {
    loop {
        ...
        io::stdin()
            .read_line(&mut dealing_round)
            .expect("Couldn't read the dealing round");
